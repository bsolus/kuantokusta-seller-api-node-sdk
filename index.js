...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'kuantokusta/1.0.1 (api/6.1.2)');
    }
    /**
     ...
     */
    SDK.prototype.orderController_findAll = function (metadata) {
     ...
     */
    SDK.prototype.orderController_count = function (metadata) {
     ...
     */
    SDK.prototype.orderController_findOne = function (metadata) {
     ...
     */
    SDK.prototype.orderController_approveOrder = function (metadata) {
     ...
     */
    SDK.prototype.orderController_sendOrder = function (body, metadata) {
     ...
     */
    SDK.prototype.orderController_cancelOrder = function (body, metadata) {
     ...
     */
    SDK.prototype.offerController_readOne = function (metadata) {
     ...
     */
    SDK.prototype.offerController_readMany = function (metadata) {
     ...
     */
    SDK.prototype.offerController_updatePrice = function (body, metadata) {
     ...
     */
    SDK.prototype.offerController_updateStock = function (body, metadata) {
     ...
     */
    SDK.prototype.cancellationReasonsController_findAll = function (metadata) {
     ...
     */
    SDK.prototype.couriersController_findAll = function (metadata) {
